...
def login():
    ...
    layout = [
        ...
        [sg.Ok(button_color="#4169E1"), sg.B("Voltar", button_color="#4169E1")],
...
def registro():
    ...
    layout = [
        ...
        [sg.Ok(button_color="#4169E1"), sg.B("Cancel",button_color="#4169E1")],
...
def anotações():
    ...
    frame_layout = [
        ...
        sg.Button("Deletar", button_color="#4169E1",size=(10,2), pad=(16,2)),
    ...
    if button == sg.WINDOW_CLOSED:
        ...
        def novo_texto():
            frame_layout = [
                [sg.Text("Nome do texto: ", font=("Arial", 10)), sg.Input(key="-TAG-")]
            ]
